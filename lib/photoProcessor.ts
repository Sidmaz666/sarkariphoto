...
export const PRESETS: Preset[] = [
  // India · Identity (gov.in / UIDAI / Parivahan specs)
  { id:"india-passport", name:"Indian Passport (online form)", category:"India · Identity", description:"200×230 px · 20–50 KB · white bg", widthPx:200, heightPx:230, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"india-passport-seva", name:"Passport Seva (digital upload)", category:"India · Identity", description:"350×350 px min · 20–300 KB · square", widthPx:350, heightPx:350, minKB:20, maxKB:300, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"india-pan", name:"PAN Card (NSDL / UTIITSL)", category:"India · Identity", description:"213×213 px · 20–50 KB", widthPx:213, heightPx:213, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"india-aadhaar", name:"Aadhaar (UIDAI 35×45 mm)", category:"India · Identity", description:"413×531 px · 20–50 KB · 3.5×4.5 cm", widthPx:413, heightPx:531, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  ...
  { id:"india-oci", name:"OCI Card (ociservices.gov.in)", category:"India · Identity", description:"600×600 px · 20–200 KB · light bg", widthPx:600, heightPx:600, minKB:20, maxKB:200, format:"jpeg", bgColor:"#E8E8E8" },
  ...
  { id:"india-police-pcc", name:"Police PCC / Verification", category:"India · Identity", description:"200×230 px · 20–50 KB", widthPx:200, heightPx:230, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  ...
  { id:"india-evisa", name:"Indian e-Visa", category:"India · Travel", description:"350×350 px · 10–300 KB · square", widthPx:350, heightPx:350, minKB:10, maxKB:300, format:"jpeg", bgColor:"#FFFFFF" },
  ...
  { id:"nda", name:"NDA (UPSC)", category:"India · Exams", description:"200×230 px · 20–50 KB", widthPx:200, heightPx:230, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"cds", name:"CDS (UPSC)", category:"India · Exams", description:"200×230 px · 20–50 KB", widthPx:200, heightPx:230, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"afcat", name:"AFCAT (IAF)", category:"India · Exams", description:"200×230 px · 20–50 KB", widthPx:200, heightPx:230, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  ...
  { id:"rbi", name:"RBI Grade B / Assistant", category:"India · Exams", description:"200×230 px · 20–50 KB", widthPx:200, heightPx:230, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"lic", name:"LIC / Insurance exams", category:"India · Exams", description:"200×230 px · 20–50 KB", widthPx:200, heightPx:230, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"railway-rrb", name:"Railway RRB / NTPC", category:"India · Exams", description:"240×320 px · 15–40 KB", widthPx:240, heightPx:320, minKB:15, maxKB:40, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"ctet", name:"CTET / TET", category:"India · Exams", description:"200×230 px · 20–50 KB", widthPx:200, heightPx:230, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"cuet", name:"CUET (UG / PG)", category:"India · Exams", description:"200×230 px · 20–50 KB", widthPx:200, heightPx:230, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"clat", name:"CLAT (Law)", category:"India · Exams", description:"200×230 px · 20–50 KB", widthPx:200, heightPx:230, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"ugc-net", name:"UGC NET / JRF", category:"India · Exams", description:"200×230 px · 20–50 KB", widthPx:200, heightPx:230, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"csir-net", name:"CSIR NET", category:"India · Exams", description:"200×230 px · 20–50 KB", widthPx:200, heightPx:230, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"state-psc", name:"State PSC (general)", category:"India · Exams", description:"200×230 px · 20–50 KB", widthPx:200, heightPx:230, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"agniveer", name:"Agniveer (Army / Navy / AF)", category:"India · Exams", description:"200×230 px · 20–50 KB", widthPx:200, heightPx:230, minKB:20, maxKB:50, format:"jpeg", bgColor:"#FFFFFF" },
  // International (ICAO / embassy digital specs)
  { id:"icao-35x45", name:"ICAO Standard (35×45 mm)", category:"International", description:"413×531 px · 20–500 KB · visa standard", widthPx:413, heightPx:531, minKB:20, maxKB:500, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"us-passport", name:"US Passport (2×2 in)", category:"International", description:"600×600 px · 50–240 KB", widthPx:600, heightPx:600, minKB:50, maxKB:240, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"us-ds160", name:"US Visa (DS-160)", category:"International", description:"600×600 px · ≤240 KB · square JPEG", widthPx:600, heightPx:600, minKB:50, maxKB:240, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"uk-passport", name:"UK Passport (digital)", category:"International", description:"600×750 px · 50–250 KB", widthPx:600, heightPx:750, minKB:50, maxKB:250, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"uk-visa", name:"UK Visa (35×45 mm)", category:"International", description:"413×531 px · 20–500 KB", widthPx:413, heightPx:531, minKB:20, maxKB:500, format:"jpeg", bgColor:"#FFFFFF" },
  ...
  { id:"germany-visa", name:"Germany Visa", category:"International", description:"413×531 px · 20–500 KB", widthPx:413, heightPx:531, minKB:20, maxKB:500, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"france-visa", name:"France Visa", category:"International", description:"413×531 px · 20–500 KB", widthPx:413, heightPx:531, minKB:20, maxKB:500, format:"jpeg", bgColor:"#FFFFFF" },
  ...
  { id:"new-zealand-visa", name:"New Zealand Visa (digital)", category:"International", description:"900×1200 px · 50–500 KB", widthPx:900, heightPx:1200, minKB:50, maxKB:500, format:"jpeg", bgColor:"#FFFFFF" },
  ...
  { id:"korea-visa", name:"South Korea Visa", category:"International", description:"413×531 px · 20–500 KB", widthPx:413, heightPx:531, minKB:20, maxKB:500, format:"jpeg", bgColor:"#FFFFFF" },
  ...
  { id:"malaysia-visa", name:"Malaysia Visa (35×50 mm)", category:"International", description:"413×590 px · 20–500 KB", widthPx:413, heightPx:590, minKB:20, maxKB:500, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"hong-kong-visa", name:"Hong Kong Visa (40×50 mm)", category:"International", description:"472×591 px · 20–500 KB", widthPx:472, heightPx:591, minKB:20, maxKB:500, format:"jpeg", bgColor:"#FFFFFF" },
  { id:"brazil-visa", name:"Brazil Visa (5×7 cm)", category:"International", description:"591×827 px · 20–500 KB", widthPx:591, heightPx:827, minKB:20, maxKB:500, format:"jpeg", bgColor:"#FFFFFF" },
  // Professional
